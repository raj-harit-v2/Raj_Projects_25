"""Pull gemma3:12b model using Ollama API"""
import requests
import json

print("Pulling gemma3:12b model...")
...
try:
    ...
    if response.status_code == 200:
        print("\n[SUCCESS] gemma3:12b model pulled successfully!")
        print("\nYou can now use gemma3:12b in profiles.yaml")
    else:
